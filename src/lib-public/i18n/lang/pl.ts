export const pl = {
  ...
  invoice: {
    ...
    annotations: {
      ...
      simplifiedWeInfoice:
        'Faktura WE uproszczona na mocy art. 135-138 ustawy o pt/artykułu 141 dyrektywy 2006/112/WE. Podatek z tytułu dokonanej dostawy zostanie rozliczony przez ostatniego w kolejności podatnika podatku od wartości dodanej',
    ...
    upo: {
      ...
      upoPageTotal: 'Całkowita liczba części dokumentu UPO: ',
